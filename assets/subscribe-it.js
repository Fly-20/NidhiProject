  ...
  .slider.round:before {
    ...
    SI.Config = {
      ...
      "button": {
                ...
                "position": "right-top",
                "corner_offset": 100,
                "background_color": "#ded5cb",
                "selected_selector": ".product-single__meta--wrapper",
      ...
      "main_button": {
            ...
            "main_hover_text_color": "#0f0f0f",
            "main_text_style": "",
            "main_background_color": "#ded5cb",
            "main_hover_background_color": "#f9f5f3",
            "main_border_color": "#ded5cb",
            "main_hover_border_color": "#f9f5f3",
            "main_border_size": "",
            "main_border_radius": ""
      },
      "partials": {},
        ...
        "shop": "wholydosewellness.myshopify.com",
        ...
        SI.Config.shop = 'wholydosewellness.myshopify.com';
...
.appikon-bis-inline-form-wrapper .appikon-bis-inline-form-input {
    appearance: none;
    margin: 0;
    width: 100%;
    line-height: 40px;
        ...
        <div class="clearfix">
            ...
            <div class="appikon-bis-inline-form-data">
                <form id="appikon-bis-inline-form">
                    <input id="appikon-bis-inline-form-email" class="appikon-bis-inline-form-input" type="email" name="appikon-bis-inline-form-email"
            ...
            <div class="appikon-bis-inline-form-footer">
                ...
                <div class="appikon-bis-inline-form-powered-by">
                    <hr>
                    <span>Powered by
                        <a href="https://apps.shopify.com/customer-back-in-stock-alert-user-notification-app/?utm_source=referral&utm_medium=powered-by&utm_campaign={{Shopify.shop}}" target="_blank">Back In Stock (by Appikon)</a>
                    </span>
                </div>
                {{/madeby_link_visible}}
            </div>
...
var appikonBisInlineForm = jQuery(Mustache.render(appikonBisInlineFormTemplate.trim(), appikonBisInlineFormTemplateVars));

appikonBisInlineForm.find('#appikon-bis-inline-form-email').on('change', function (t) {
    var appikonBisInlineFormEmail = appikonBisInlineForm.find('#appikon-bis-inline-form-email').val();
    const emailPattern = /^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})+$/; //email simple pattern
    if (!emailPattern.test(appikonBisInlineFormEmail)) {
        $('#appikon-bis-form-email-warning').removeClass("appikon-bis-form-hide-warning").addClass("appikon-bis-form-warning");
        $('#appikon-bis-inline-form-submit').attr("disabled","true");
    }else {
        $('#appikon-bis-form-email-warning').removeClass("appikon-bis-form-warning").addClass("appikon-bis-form-hide-warning");
        $('#appikon-bis-inline-form-submit').removeAttr("disabled","true");
    }
})
...
appikonBisInlineForm.find('#appikon-bis-inline-form-submit').on('click', function (t) {
    ...
    SI.create(appikonBisInlineFormEmail, appikonBisInlineFormVariantId, SI.popup.product.id)
        .then(function (st, resp) {
            resp = SI.parseJSON(resp);

            if("OK" === resp.status) {
                appikonBisInlineFormMessage.html($("<p>", {
  ...
  @keyframes fade-in-anim-KT {
    ...
    function setBisProductPageButtonStyles() {
      ...
      if(mainButtonSettings.main_hover_text_color) {
        ...
        mainButton.hover(
          function(){
            originalMainButtonHoverTextColor = $(this).css("color");
            $(this).css("color", mainButtonSettings.main_hover_text_color);
          },
          function(){
            $(this).css("color", originalMainButtonHoverTextColor
      ...
      if(mainButtonSettings.main_hover_background_color) {
        ...
        mainButton.hover(
          function(){
            originalMainHoverBgColor = $(this).css("background-color");
            $(this).css("background-color", mainButtonSettings.main_hover_background_color);
          },
          function(){
            $(this).css("background-color", originalMainHoverBgColor
      ...
      if(mainButtonSettings.main_hover_border_color) {
        ...
        mainButton.hover(
          function(){
            originalMainHoverBorderColor = $(this).css("border-color");
            $(this).css("border-color", mainButtonSettings.main_hover_border_color);
          },
          function(){
            $(this).css("border-color", originalMainHoverBorderColor
